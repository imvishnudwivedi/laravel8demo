    ...
    <div class="box box-primary">
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
          ...
          {!!Form::model($news,array('route' => array('vidyaaarambha.news.update', $news->id), 'method' => 'PUT','files'=>true,'id'=>'edit-form'))!!}
          {!!Form::hidden('id',$news->id)!!}

          @include('vidyaaarambha.News._form',['submitButtonText'=>'Update'])
