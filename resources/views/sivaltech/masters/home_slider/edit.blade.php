    ...
    <div class="box box-primary">
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <div class="col-md-12">
         ...
         {!!Form::model($home_slider,array('route' => array('sivaltech.masters.home_slider.update', $home_slider->id), 'method' => 'PUT','files'=>true,'id'=>'edit-form','onSubmit'=>'return validate()'))!!}
...
<div class="col-md-2 pull-right">
  <a href="{{URL::route('sivaltech.masters.home_slider.index')}}">{!! Form::button('Cancel', ['class' => 'btn btn-block btn-danger btn-block','id'=>'clr-btn']) !!}</a>
</div>
<div class="col-md-2 pull-right">
...
console.log(11111111);
  ...
  var ajax = $.ajax({
    type: 'post',
    url:'{{URL::route("sivaltech.masters.home_slider.uploadSliderImage")}}',
