        ...
        <div class="container">
            <div class="row footer-top">
                <div class="col-md-8 col-lg-8">
                    <h3>Let’s start your next design together</h3>
                </div>
                <div class="col-md-4 col-lg-4">
                    <div class="contact-right">
                        <a href="contact" class="contact-us">Contact Us <span class="icon"><i
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    <div class="section-title">
                        <h4>Vision</h4>
                        <p style="font-size:16.5px;line-height:22px;"><font color="white">To become a leading service provider in VLSI & Embedded Software by exceeding expectations on delivery, meeting stringent schedules, demonstrating integrity and intelligence in all our engagements</font></p><br>
